    ...
    <div class="container-fluid position-relative bg-white d-flex p-0">
            ...
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="d-flex align-items-center ms-4 mb-4">
                    <div class="position-relative">
                        <img class="rounded-circle me-lg-2" src="admin_pic.png" alt="profile_pic" style="width: 80px; height: 80px;">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="vaccines_admin.php" class="nav-item nav-link active"><i class="fas fa-syringe fa me-2"></i>Vaccines</a>
        ...
        <div class="content">
            ...
            <div class="container-fluid text-center" style="margin-top: 4%;">
                <a href="vaccines_admin_upload.php" class="btn btn-primary w-50 rounded-pill" style="font-size: 20px; font-weight:bold; ">Click Here to Upload Data</a>
            </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header text-white">
                                <h4 class="text-dark text-center mt-3">Uploaded Vaccines</h4>
                            </div>
                            <div class="card-body">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="vaccines_admin_edit.php?editid=<?php echo $row['id']; ?>" class="btn btn-danger rounded-pill w-100">EDIT</a>

                                                            <form action="vaccines_admin_code.php" method="POST" class="d-inline">
                                                                ...
                                                                <button type="submit" name="delete_stud_image" class="btn btn-danger rounded-pill mt-1 w-100">DELETE</button>
                                                            </form>
