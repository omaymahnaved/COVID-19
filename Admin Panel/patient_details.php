        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="patient_details.php" class="nav-item nav-link active"><i class="fas fa-user-injured me-2"></i>Patients</a>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                ?>
                                <?php
                                $query = "SELECT * FROM covid_test_form";
                                $query_run = mysqli_query($connection, $query);
                                ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <form action="" method="POST" class="d-inline">
                                                                ...
                                                                <button type="submit" name="delete_stud_image" class="btn btn-danger rounded-pill  mt-1">Delete</button>
                                                            </form>
                                                        </td>
                                                    </tr>
                                                <?php
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <form action="" method="POST" class="d-inline">
                                                                ...
                                                                <button type="submit" name="delete_stud_image_c" class="btn btn-danger rounded-pill  mt-1">Delete</button>
                                                            </form>
                                                        </td>
                                                    </tr>
                                                <?php
