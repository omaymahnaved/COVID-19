...
if (isset($_POST['submit'])) {
    ...
    $h_condition = mysqli_real_escape_string($connection, $_POST['h_condition']);

    $queryinsert = "INSERT INTO `covid_test_form` (`name`,`email`,`hospital`,`h_condition`) VALUES ('$name','$email','$hospital','$h_condition')";
            ...
            <div class="row g-5">
                <div class="col-lg-6 h-100 wow fadeInUp" data-wow-delay="0.2s">
                    <div class="text-center mx-auto pb-5" style="max-width: 800px;">
                        <h1 class="text-uppercase" style="color: #8c52ff; font-weight:bold;margin-top:5%;">Get</h1>
                        <h1 class="display-3 text-capitalize mb-3">Covid Test</h1>
                    </div>
                    <form action="" method="POST" onsubmit="showAlert()">
                        <div class="row g-4">
                            ...
                            <div class="col-lg-12 col-xl-12">
                                <div class="form-floating">
                                    <textarea id="h_condition" name="h_condition" class="form-control border-0 rounded" style="height: 100px;" required></textarea>
                                    <label for="h_condition">Health Condition</label>
                                </div>
                            </div>
                            <div class="col-12 text-center">
                                <button type="submit" value="SUBMIT" name="submit" class="btn btn-custom w-50 py-3">Submit</button>
                            </div>
                        </div>
                    </form>
                </div>
                    ...
                    <div class="row g-4">
                        <div class="col-12 mt-2">
                            <div class="h-100 mt-5">
                                <img src="img/covid_test_banner.png" alt="IMAGE" class="img-fluid rounded">
                            </div>
                        </div>
                    </div>
                </div>
