...
if (isset($_POST['submit'])) {
  ...
  $queryselect = "SELECT * FROM hospital_registeration WHERE email = '$email' && password = '$pass'";
  ...
  if (mysqli_num_rows($result) > 0) {
    ...
    $queryinsert = "INSERT INTO `hospital_registeration`(`name`, `phone`,`address`, `email`, `password`) VALUES ('$name','$phone','$address','$email','$pass')";
          ...
          <?php if (isset($_SESSION['username_hospital'])) { ?>
            <div class="nav-item dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-end bg-light border-0 rounded m-0">
                <a href="logout.php" class="dropdown-item rounded">Log Out</a>
              </div>
            </div>
          <?php } else { ?>
            <div class="nav-item dropdown">
    ...
    <div class="container py-5">
      <div class="row g-5">
        <div class="col-lg-6 col-md-12 wow fadeInUp" data-wow-delay="0.2s">
          <div class="text-center mx-auto pb-3" style="max-width: 800px; margin-top:10%;">
            <h1 class="display-3 text-capitalize mb-3">Register Hospital</h1>
          </div>
          <form action="" method="POST" onsubmit="showAlert()">
            <div class="row g-4">
              <div class="col-12">
                <div class="form-floating">
                  <input type="text" class="form-control border-0 rounded" id="name" placeholder="Your Name" name="name">
                  <label for="name">Hospital Name</label>
                </div>
              </div>
              <div class="col-12">
                <div class="form-floating">
                  <input type="tel" class="form-control border-0 rounded" id="name" placeholder="Your Name" name="phone">
                  <label for="phone">Hospital Phone</label>
                </div>
              </div>
              <div class="col-12">
                <div class="form-floating">
                  <input type="text" class="form-control border-0 rounded" id="address" placeholder="Your Address" name="address">
                  <label for="address">Hospital Address</label>
                </div>
              </div>
              <div class="col-12">
                <div class="form-floating">
                  <input type="email" class="form-control border-0 rounded" id="email" placeholder="Your Email" name="email">
                  <label for="email">Hospital Email</label>
                </div>
              </div>
              <div class="col-12">
                <div class="form-floating">
                  <input type="password" class="form-control border-0 rounded" id="password" placeholder="Your Password"
                    name="password">
              ...
              <div class="col-12">
                <div class="form-floating">
                  <input type="password" class="form-control border-0 rounded" id="cpassword" placeholder="Confirm Password"
                    name="cpassword">
        ...
        <div class="col-lg-6 col-md-12 wow fadeInUp" data-wow-delay="0.4s">
          <div class="row g-4">
            <div class="col-12">
              <div class="h-100">
                <img src="../Hospital/img/regformimg..png" alt="" class="img-fluid rounded">
              </div>
            </div>
          </div>
        </div>
