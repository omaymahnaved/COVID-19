...
if (isset($_POST['submit'])) {
  ...
  // Create the query
  $queryselect = "SELECT * FROM registeration WHERE email = '$email' AND password = '$pass'";
  ...
  if (mysqli_num_rows($result) > 0) {
    ...
    if ($row['user_type'] == 'user') {
      $_SESSION['username_user'] = $row['name'];
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        <div class="navbar-nav ms-auto py-0">
          ...
          <?php } else { ?>
            <div class="nav-item dropdown">
              <a href="#" class="nav-link dropdown-toggle active rounded px-3" data-bs-toggle="dropdown">
                Login
              </a>
              <div class="dropdown-menu dropdown-menu-end bg-light border-0 rounded m-0">
                <a href="hospital/signup.php" class="dropdown-item  rounded-top">Hospital</a>
                <a href="signup.php" class="dropdown-item rounded-bottom active">Patient</a>
              </div>
            </div>
          <?php } ?>
        </div>
      ...
      <div class="row g-5">
        <div class="col-lg-6 col-md-12 wow fadeInUp" data-wow-delay="0.2s">
          ...
          <form action="" method="POST" onsubmit="showAlert()">
            <div class="row g-4">
              ...
              <div class="col-12">
                <div class="form-floating">
                  <input type="password" class="form-control border-0 rounded" id="password" placeholder="Your Password" name="password">
        ...
        <div class="col-lg-6 col-md-12 wow fadeInUp" data-wow-delay="0.4s">
          <div class="row g-4">
            <div class="col-12">
              <div class="h-100">
                <img src="img/loginformimg.png" alt="" class="img-fluid rounded">
              </div>
            </div>
          </div>
        </div>
