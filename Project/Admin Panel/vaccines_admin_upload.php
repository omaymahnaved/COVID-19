...
if (isset($_POST['submit'])) {
    ...
    $queryinsert = "INSERT INTO `vaccines`(`id`,`title`, `description`) VALUES ('$id','$title','$description')";
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header" style="background-color: beige;">
                                <h4 class="text-center">Upload Vaccines</h4>
                                <h6 class="text-center mt-3">(Only Add 6 Vaccines)</h6>
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <form action="" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group mt-5 text-center">
                                        <button type="submit" name="submit" class="btn btn-primary w-50 rounded-pill" style="font-size: 20px; font-weight:bold; ">Upload</button>
                                    </div>
                                </form>
                            </div>
                        </div>
