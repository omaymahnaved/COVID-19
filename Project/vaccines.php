...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto py-0">
                    ...
                    <a href="vaccines.php" class="nav-item nav-link px-3 active">Vaccines</a>
    ...
    <!-- Header Start -->
    <div class="container-fluid bg-breadcrumb mb-4" style="background-image: url('img/contactBanner.png'); background-size: cover; background-position: center;">
        <div class="container text-center py-5" style="max-width: 900px;margin-top:5%;">
            <!-- Search Form -->
            <form action="" method="get" class="mt-5">
                <div class="input-group">
                    <input type="text" class="form-control bg-white rounded-pill me-2" name="search" placeholder="Search Vaccines..." aria-label="Search Vaccines" aria-describedby="search-button">
                    <button class="btn btn-primary rounded-pill" type="submit" id="search-button">Search</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <div class="container-fluid blog py-5">
        <div class="container py-5">
            <div class="text-center mx-auto pb-5 wow fadeInUp" data-wow-delay="0.2s" style="max-width: 800px;">
                <h4 style="color: #8c52ff; font-weight: bold;" class="text-uppercase">OUR</h4>
                <h1 class="display-3 text-capitalize mb-3">Vaccines</h1>
            </div>
            <div class="row g-4 justify-content-center">
                <?php
                $search = isset($_GET['search']) ? mysqli_real_escape_string($connection, $_GET['search']) : '';
                $query = "SELECT * FROM `vaccines` WHERE `title` LIKE '%$search%' OR `description` LIKE '%$search%'";
                            ...
                            <div class="product-item" style="height: 300px;">
                                <div class="product-content rounded-bottom p-4">
                                    <?php if ($status === 'Available') { ?>
                                        <p style="font-family: sans-serif;" class="h4 mb-3 fw-bold text-center">
                                            <?php echo $title; ?>
                                        </p>
                                        <p class="mb-3 text-center text-secondary fw-bold"><?php echo $description; ?></p>
                                    <?php } else { ?>
                                        <p style="font-family: sans-serif;" class="h4 mb-3 fw-bold text-center">
                                            <?php echo $title; ?>
                                        </p>
                                        <h4 class="mb-3 text-center text-secondary fw-bold">Out of Stock</h4>
                                    <?php } ?>
                                </div>
                            </div>
                        </div>
