    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        <div class="navbar-nav ms-auto py-0">
          ...
          <?php } else { ?>
            <div class="nav-item dropdown">
              <a href="#" class="nav-link dropdown-toggle px-3 active" data-bs-toggle="dropdown">
                Login
              </a>
              <div class="dropdown-menu dropdown-menu-end bg-light border-0 rounded m-0">
                <a href="hospital/signup.php" class="dropdown-item  rounded-top">Hospital</a>
                <a href="signup.php" class="dropdown-item active rounded-bottom">Patient</a>
              </div>
            </div>
          <?php } ?>
        </div>
    ...
    <div class="container py-5">
      <div class="row g-5">
        <div class="col-lg-6 col-md-12 wow fadeInUp" data-wow-delay="0.2s">
          <div class="text-center mx-auto pb-5" style="max-width: 800px;">
            <h4 class="text-uppercase"
              style="color: #8c52ff; font-weight:bold;font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;">
              Let’s Connect</h4>
            ...
            <div class="row g-4">
              <div class="col-12">
                <div class="form-floating">
                  <input type="text" class="form-control border-0 rounded" id="name"
              ...
              <div class="col-12">
                <div class="form-floating">
                  <input type="password" class="form-control border-0 rounded" id="cpassword"
              ...
              <div class="col-12 text-center">
                ...
                <p class="text-center mt-3">Already have an account? <a href="login.php">Login now</a>
                </p>
              </div>
            </div>
          </form>
        ...
        <div class="col-lg-6 col-md-12 wow fadeInUp" data-wow-delay="0.4s">
          <div class="row g-4">
            <div class="col-12">
              <div class="h-100" style="margin-bottom: 5%;">
                <img src="img/regformimg.png" alt="" class="img-fluid rounded">
              </div>
            </div>
          </div>
        </div>
